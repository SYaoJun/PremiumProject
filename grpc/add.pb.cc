...
void AddRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  if (from._internal_operand1() != 0) {
    _this->_impl_.operand1_ = from._impl_.operand1_;
  }
  if (from._internal_operand2() != 0) {
    _this->_impl_.operand2_ = from._impl_.operand2_;
  }
...
::google::protobuf::Metadata AddRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_add_2eproto_getter,
                                   &descriptor_table_add_2eproto_once,
